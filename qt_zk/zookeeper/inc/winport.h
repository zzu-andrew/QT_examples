...
typedef struct pthread_t_ pthread_t_;
...
int pthread_create(pthread_t_ *thread, const int *attr, unsigned  (__stdcall* start_routine)(void* a), void *arg);
int pthread_equal(pthread_t_ t1, pthread_t_ t2);
//int pthread_self();
int pthread_join(pthread_t_ _thread, void** ignore);
int pthread_detach(pthread_t_ _thread);

void pthread_mutexattr_init(int* ignore);
void pthread_mutexattr_settype(int* ingore_attr, int ignore);
void pthread_mutexattr_destroy(int* ignore_attr);
...
typedef struct pthread_key_t_ pthread_key_t__;
int pthread_key_create(pthread_key_t__ *key, void (*destructor)(void *) );
int pthread_key_delete(pthread_key_t__ key);
void *pthread_getspecific(pthread_key_t__ key);
int pthread_setspecific(pthread_key_t__ key, const void *value);
